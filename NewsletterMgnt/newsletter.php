...
if (isset($_POST['recipient'], $_POST['subject'], $_POST['template'])) {
    // From address
    $from = 'Lazeeza Newsletter <donotreply@lazeeza.flamingfrisbee.com>';
	// Email Headers
    ...
    if ($subscriber) {
        ...
        $unsubscribe_link = 'https://lazeeza.flamingfrisbee.com/NewsletterMgnt/unsubscribe.php?email=' . $subscriber['email'] . '&code=' . sha1($subscriber['id'] . $subscriber['email']);
